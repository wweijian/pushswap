...
/*   Updated: 2025/05/27 10:15:27 by wjhoe            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static int	ft_partition(int *stack, int start_index, int end_index)
{
	int	pivot;
	int	i;
	int	j;
...
static void	ft_quicksort(int *stack, int start_index, int end_index)
{
	int	pivot_index;
